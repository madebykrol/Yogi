...
class ContentAuthorizationFilter extends FilterAttribute implements IAuthorizationFilter {
	...
	public function setContentPermissionHandler(IContentPermissionHandler $permissionHandler) {
	...
	public function onAuthorization(AuthorizationContext $context) {
		...
		if($identity->isAuthenticated() && $context->getController()->getPrincipal()->getRoles() != null) {
			foreach(
