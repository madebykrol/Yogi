...
class SqlContentRepository implements IContentRepository
{
     ...
     */
    public function addPageType($type, $file, $controller, $name, 
            $permissions, $description = null, Guid $guid = null)
    {
    ...
    public function findPageWithCriteria(IPageReference $page, 
               IPropertyCriteriaCollection $criteriaCollection)
    {
