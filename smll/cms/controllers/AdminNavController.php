...
class AdminNavController extends Controller {
	...
	public function post_editContentTreeNav(ContentNavTreeModel $menu = null) {
		...
		if(isset($menu)) {
			if($menu->parent != "menu-root") {
				$parent = $this->contentRepository->getPageReference(Guid::parse(str_replace('parent-', '', $menu->parent)))->getId();
			}
	...
	protected function recursiveMenuTreeBuilder(IPageReference $page, IMenuItem $item, $active = null) {
