...
abstract class HttpApplication Implements IApplication {
    ...
    public function processAction($controller, $actionName, 
            HashMap $parameters = null)
    {
        ...
        if ($controller instanceof IController) {
            ...
            $oldCurrentExecutingController = $this->currentExecutingController;
            ...
            if ($oldCurrentExecutingController != null) {
                // If we don't reset this, internal MVC calls will mess up the call stack
                $this->currentExecutingController = $oldCurrentExecutingController;
            }
            // Output Action.
        } else {
            throw new Exception();
